...
// router.post("/menitem", itemController.createMenItem);

// router.post("/womenitem", itemController.createWomenItem);

// router.post("/limiteditem", itemController.createLimitedItem);

// router.post("/kidsitem", itemController.createKidsItem);

// router.post("/saleitem", itemController.createSaleItem);
